...
export const FullPreconceptionScene2: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          WHY TODAY'S NUTRITION SHAPES FUTURE QUALITY
        </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          >
            ...
            >
              Oocytes and sperm require 3 full months to develop. Cellular environment today dictates egg quality later.
            </div>
          </div>
