...
export const BreastfeedingScene3: React.FC = () => {
  ...
  // Bottle water level fill percentage animation (25% -> 90%)
  ...
  return (
    <AbsoluteFill className="bg-[#FAF6F0] overflow-hidden select-none">
      {/* Background Image: Flat-lay food photography on blush pink table */}
      <Img
        className="absolute inset-0 w-full h-full object-cover object-center"
        style={{ transform: `scale(${scale})` }}
        src={staticFile("assets/breastfeeding_scene3_flatlay_drinks.png")}
      />

      <BokehParticles count={15} opacity={0.65} />

      {/* Soft gradient overlay to ensure UI readability */}
      <div
        ...
        >
          <GlassCard className="px-6 py-4 flex flex-col items-center" variant="light">
            <div className="flex items-center justify-center space-x-6 mb-2">
              {/* Animated Filling Reusable Water Bottle */}
