...
export const BreastfeedingHydrationScene4: React.FC = () => {
  ...
  return (
    <AbsoluteFill className="bg-[#FAF6F0] overflow-hidden select-none">
      {/* Background Image: Mother sipping water from luxury thermal flask */}
      <Img
        className="absolute inset-0 w-full h-full object-cover object-center"
        style={{ transform: `scale(${scale})` }}
        src={staticFile("assets/bf_hydration_v2_scene4_mother_sipping.png")}
      />
