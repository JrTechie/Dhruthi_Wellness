...
export const PCOSScene3: React.FC = () => {
  ...
  return (
    <AbsoluteFill className="bg-black overflow-hidden flex flex-col justify-center items-center py-24 px-16">
      ...
      <Img
        ...
        src={staticFile("assets/pcos_scene3_consult.png")}
      />
      ...
      <AbsoluteFill className="flex flex-col justify-center items-center px-12 text-center select-none z-10 pt-16">
        ...
        <div className="w-full flex flex-col items-center mb-6">
          ...
          <div
            style={{
              ...
              backgroundColor: "rgba(21, 16, 18, 0.45)",
              backdropFilter: "blur(12px)",
              WebkitBackdropFilter: "blur(12px)",
              border: "1.5px solid rgba(250, 246, 240, 0.15)"
            }}
            className="flex items-center space-x-6 px-8 py-4 rounded-2xl w-[680px] justify-start shadow-md"
          >
            <div
              style={{ backgroundColor: COLORS_PCOS.orchid, color: COLORS_PCOS.linen }}
              className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-[28px] shrink-0"
            >
              1
            </div>
            <span style={{ color: COLORS_PCOS.linen }} className="text-[34px] font-bold">
              Insulin Resistance Blocks Energy
            </span>
          </div>
          ...
          >
            <div
              style={{ backgroundColor: COLORS_PCOS.emerald, color: COLORS_PCOS.espresso }}
              className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-[28px] shrink-0"
            >
              2
            </div>
            <span style={{ color: COLORS_PCOS.linen }} className="text-[34px] font-bold flex items-center">
              Cortisol Rise Halts Ovulation
              <svg
                width="26"
                height="26"
                viewBox="0 0 24 24"
                ...
                stroke="currentColor"
                strokeWidth="3.5"
                className="ml-3 inline text-[#FF1493]"
              >
          ...
          >
            ...
            <span style={{ color: COLORS_PCOS.linenMuted }} className="text-[34px] font-bold">
              Low Progesterone Triggers PMS
            </span>
          </div>
        </div>
        ...
        <div
          style={{
            ...
            opacity: summaryO,
            fontFamily: fonts.body,
            backgroundColor: "rgba(21, 16, 18, 0.5)",
            backdropFilter: "blur(12px)",
            WebkitBackdropFilter: "blur(12px)",
            border: "1.5px solid rgba(250, 246, 240, 0.15)"
          }}
        ...
        >
          ...
          >
            Uncover the metabolic blocks to{" "}
            <span
