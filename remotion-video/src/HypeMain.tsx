...
import { HypeScene1 } from "./HypeScene1";
import { HypeScene2 } from "./HypeScene2";
import { HypeScene3 } from "./HypeScene3";
import { HypeScene4 } from "./HypeScene4";
import { HypeScene5 } from "./HypeScene5";

export const HypeMain: React.FC = () => {
  ...
  return (
    <AbsoluteFill className="bg-[#FAF6F0]">
      ...
      {/* Top Cyber Progress Bar */}
      <div
        style={{
          width: `${progressPercent}%`,
          height: "8px",
          background: "linear-gradient(to right, #00FF9D, #FF5A36)",
          position: "absolute",
          top: 0,
          left: 0,
          zIndex: 60,
