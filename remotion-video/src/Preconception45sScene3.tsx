...
export const Preconception45sScene3: React.FC = () => {
  ...
  const cards = [
    { num: "01", title: "Thyroid (TSH < 2.5 mIU/L)", desc: "Subclinical TSH > 2.5 can quietly delay luteal support.", color: "#00E5FF", delay: 30 },
    { num: "02", title: "Insulin Sensitivity & HbA1c", desc: "High insulin impairs ovulation & endometrial receptivity.", color: "#00FF9D", delay: 130 },
    { num: "03", title: "Ferritin, Vitamin D & Inflammation", desc: "Sufficient nutrient storage drives healthy implantation.", color: "#C5A059", delay: 230 }
  ];
