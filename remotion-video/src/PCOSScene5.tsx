...
export const PCOSScene5: React.FC = () => {
  ...
  return (
    <AbsoluteFill className="bg-black overflow-hidden flex flex-col justify-center items-center py-24 px-16">
      ...
      <Img
        ...
        src={staticFile("assets/pcos_scene5_wellness.png")}
      />
      ...
      <AbsoluteFill className="flex flex-col justify-center items-center px-12 text-center select-none z-10 pt-16">
        ...
        >
          <h2 style={{ color: COLORS_PCOS.linen }} className="text-[84px] font-semibold leading-none tracking-tight">
            Restore Cycles.
          </h2>
          <h2 style={{ color: COLORS_PCOS.linen }} className="text-[84px] font-semibold leading-none mb-6 tracking-tight">
            Reclaim Energy.
          </h2>
          {/* Orchid divider */}
          <div
        ...
        <div
          style={{
            ...
            backgroundColor: "rgba(21, 16, 18, 0.70)",
            backdropFilter: "blur(16px)",
            WebkitBackdropFilter: "blur(16px)",
            border: `2px solid ${COLORS_PCOS.orchid}`,
            boxShadow: "0 8px 32px rgba(255, 20, 147, 0.35)"
          }}
          className="mb-8 p-6 px-12 rounded-3xl"
        >
          <h3 style={{ color: COLORS_PCOS.orchid }} className="text-[54px] font-extrabold tracking-widest uppercase mb-1">
            @DhruthiWellness
          </h3>
          <p style={{ color: COLORS_PCOS.linenMuted }} className="text-[28px] font-light tracking-wide">
            Evidence-Based PCOS & Metabolic Health
          </p>
        </div>
        ...
        >
          <div
            style={{
              backgroundColor: COLORS_PCOS.emerald,
              boxShadow: "0 15px 40px -10px rgba(105, 219, 160, 0.45)",
            }}
            className="px-16 py-6 rounded-full inline-block border border-white/10"
          >
            <span style={{ color: COLORS_PCOS.espresso }} className="text-[36px] font-extrabold tracking-wide uppercase">
