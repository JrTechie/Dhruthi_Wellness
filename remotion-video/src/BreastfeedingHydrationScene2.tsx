...
export const BreastfeedingHydrationScene2: React.FC = () => {
  ...
  return (
    <AbsoluteFill className="bg-[#FAF6F0] overflow-hidden select-none">
      {/* Background Image: Close up water poured into luxury glass */}
      <Img
        className="absolute inset-0 w-full h-full object-cover object-center"
        style={{ transform: `scale(${scale})` }}
        src={staticFile("assets/bf_hydration_v2_scene2_macro_water.png")}
      />
      ...
      <div className="absolute inset-0 z-20 pointer-events-none flex justify-center items-center">
        <svg viewBox="0 0 1080 1920" className="w-full h-full opacity-60">
          ...
          />
          <defs>
            <linearGradient id="waterStreamGrad2" x1="0%" y1="0%" x2="0%" y2="100%">
